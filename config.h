...
static const char *screensinglecmd[] = { "dwm-scsw", "single", NULL };
static const char *screenextendcmd[] = { "dwm-scsw", "extend", NULL };
static const char *screenclonecmd[] = { "dwm-scsw", "clone", NULL };
...
static const char *logoutdialog[] = { "logout-dialog", NULL };
